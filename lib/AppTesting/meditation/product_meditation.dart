...
class ProductMeditation extends StatefulWidget {
  @override
  _ProductPageState createState() => _ProductPageState();
}

class _ProductPageState extends State<ProductMeditation> {
  @override
                            ...
                            Expanded(
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    image: DecorationImage(
                                        image:
                                            AssetImage('assets/med/img3.png'),
                                        fit: BoxFit.contain)),
                              ),
                            )
                          ],
